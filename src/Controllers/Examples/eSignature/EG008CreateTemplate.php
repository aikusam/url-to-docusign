...
class EG008CreateTemplate extends BaseController
{
    ...
    private $template_name = 'Example Signer by andrey';
    ...
    private function make_template_req(): EnvelopeTemplate
    {
        ...
        $text1 = new Text(['document_id' => "1", 'page_number' => "1",
            'x_position' => "15", 'y_position' => "130",
            'font' => "helvetica", 'font_size' => "size14", 'tab_label' => "text",
            'height' => "23", 'width' => "150", 'required' => "false"]);
        $text2 = new Text(['document_id' => "1", 'page_number' => "1",
            'x_position' => "15", 'y_position' => "150",
            'font' => "helvetica", 'font_size' => "size14", 'tab_label' => "text",
            'height' => "23", 'width' => "170", 'required' => "false"]);
        $text3 = new Text(['document_id' => "1", 'page_number' => "1",
            'x_position' => "15", 'y_position' => "170",
            'font' => "helvetica", 'font_size' => "size14", 'tab_label' => "text",
            'height' => "23", 'width' => "170", 'required' => "false"]);
        # Add the tabs model to the signer
        # The Tabs object wants arrays of the different field/tab types
        $signer->setTabs(new Tabs(['sign_here_tabs' => [$sign_here], 'text_tabs' => [$text]
        ]));
